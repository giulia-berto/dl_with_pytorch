#!/usr/bin/env python
"""5_larger_sequence_nn_gpu_axial.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1A-K5tqWf87ildGaQpguOevTPwou4Iv4i
...
transformed_dataset = HCPanatDataset(
    ...
    transform=transforms.Compose([
        CropBorders3D(n_crop),
        SelectAxialSlices3D(n_axial)]))

#check dimensions
t1, _ = transformed_dataset[0]
print("Shape of one image after crop and selection of %i axial slices:" %n_axial)
print(t1.shape)
